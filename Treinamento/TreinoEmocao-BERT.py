...
def treinarClassificacaoEmocoes(df, le):
    ...
    model.save_pretrained("Treinamento/Exportados/BERTClassificacao/Emocoes/modelo")
    tokenizer.save_pretrained("Treinamento/Exportados/BERTClassificacao/Emocoes/tokenizer")
    joblib.dump(le, "Treinamento/Exportados/BERTClassificacao/Emocoes/label_encoder.pkl")
