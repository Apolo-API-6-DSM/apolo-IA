...
def treinarClassificacaoEmocao(dataset):
    ...
    joblib.dump(tfidf, f'{base_dir}\\Treinamento\\Exportados\\emocao_vetorizador_metricas.pkl')
    joblib.dump(regressao_logistica, f'{base_dir}\\Treinamento\\Exportados\\modelo_emocao_metricas.pkl')
